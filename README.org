...
4. Enchant 2 - for spell check (Debian: libenchant-2-dev, Redhat: enchant2-devel)
5. [[https://github.com/Kitware/CMake][cmake]] - for compiling vterm
6. [[https://direnv.net][direnv]] - for managing environment variables based on current directory
